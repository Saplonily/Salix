...
EXPORT void CALLCONV MsdgSetShaderParamInt(whandle*, int loc, int value)
{
    glUniform1i(loc, value); GL_CHECK_ERROR;
}
EXPORT void CALLCONV MsdgSetShaderParamFloat(whandle*, int loc, float value)
{
    glUniform1f(loc, value); GL_CHECK_ERROR;
}
EXPORT void CALLCONV MsdgSetShaderParamVec4(whandle*, int loc, float* vec)
{
