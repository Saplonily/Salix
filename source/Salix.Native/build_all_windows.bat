...
if not exist "build_winx32" (
    ...
    cmake -B build_winx32 -G "Visual Studio 17 2022" -A Win32 -DSLX_TARGET_OS="win" -DSLX_TARGET_ARCH="x32"
)
if not exist "build_winx64" (
    echo script: build_winx64 not exists, building...
    cmake -B build_winx64 -G "Visual Studio 17 2022" -A x64 -DSLX_TARGET_OS="win" -DSLX_TARGET_ARCH="x64"
)
