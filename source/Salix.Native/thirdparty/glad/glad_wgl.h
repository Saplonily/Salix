/*
    ...
    WGL loader generated by glad 0.1.36 (custom-build) on Tue Oct  1 23:18:01 2024.
    ...
    Commandline:
        --api="wgl=1.0" --generator="c" --spec="wgl" --local-files --extensions="WGL_ARB_create_context,WGL_ARB_create_context_no_error,WGL_ARB_create_context_profile,WGL_ARB_extensions_string,WGL_ARB_pixel_format,WGL_EXT_extensions_string,WGL_EXT_swap_control,WGL_EXT_swap_control_tear"
    Online:
        https://glad.dav1d.de/#language=c&specification=wgl&loader=on&api=wgl%3D1.0&extensions=WGL_ARB_create_context&extensions=WGL_ARB_create_context_no_error&extensions=WGL_ARB_create_context_profile&extensions=WGL_ARB_extensions_string&extensions=WGL_ARB_pixel_format&extensions=WGL_EXT_extensions_string&extensions=WGL_EXT_swap_control&extensions=WGL_EXT_swap_control_tear
*/
...
inline static HGLRC wglCreateContextAttribsARB(HDC hDC, HGLRC hShareContext, const int *attribList) { return glad_wglCreateContextAttribsARB(hDC, hShareContext, attribList); }
#endif
...
inline static const char * wglGetExtensionsStringARB(HDC hdc) { return glad_wglGetExtensionsStringARB(hdc); }
#endif
...
inline static BOOL wglGetPixelFormatAttribivARB(HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, const int *piAttributes, int *piValues) { return glad_wglGetPixelFormatAttribivARB(hdc, iPixelFormat, iLayerPlane, nAttributes, piAttributes, piValues); }
...
inline static BOOL wglGetPixelFormatAttribfvARB(HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, const int *piAttributes, FLOAT *pfValues) { return glad_wglGetPixelFormatAttribfvARB(hdc, iPixelFormat, iLayerPlane, nAttributes, piAttributes, pfValues); }
...
inline static BOOL wglChoosePixelFormatARB(HDC hdc, const int *piAttribIList, const FLOAT *pfAttribFList, UINT nMaxFormats, int *piFormats, UINT *nNumFormats) { return glad_wglChoosePixelFormatARB(hdc, piAttribIList, pfAttribFList, nMaxFormats, piFormats, nNumFormats); }
#endif
...
inline static const char * wglGetExtensionsStringEXT(void) { return glad_wglGetExtensionsStringEXT(); }
#endif
...
inline static BOOL wglSwapIntervalEXT(int interval) { return glad_wglSwapIntervalEXT(interval); }
typedef int (APIENTRYP PFNWGLGETSWAPINTERVALEXTPROC)(void);
GLAPI PFNWGLGETSWAPINTERVALEXTPROC glad_wglGetSwapIntervalEXT;
inline static int wglGetSwapIntervalEXT(void) { return glad_wglGetSwapIntervalEXT(); }
#endif
